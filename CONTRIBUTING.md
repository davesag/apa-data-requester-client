# How to contribute to the APA Data Requester Client project
...
3. Set this repo as the `upstream` repo `git remote add upstream git@github.com:davesag/apa-data-requester-client.git`
